...
const MultiComparisonSlide: React.FC<MultiComparisonSlideProps> = ({ slide }) => {
  return (
        ...
        {slide.comparisons.map((comparison: any, index: number) => (
          <Card key={index} className="p-3 sm:p-4 lg:p-6">
            <CardHeader className="pb-2 sm:pb-3">
              <CardTitle className="text-base sm:text-lg lg:text-xl text-blue-600 text-center">{comparison.title}</CardTitle>
            </CardHeader>
            <CardContent>
