...
const AdvantagesSlide: React.FC<AdvantagesSlideProps> = ({
  slide
}) => {
  return <div className="space-y-4 sm:space-y-6 lg:space-y-8 px-4 py-8 sm:py-12">
      ...
      <div className="grid gap-4 sm:gap-6">
        {slide.categories.map((category: any, index: number) => <Card key={index} className="p-3 sm:p-4 lg:p-6 rounded-sm px-[20px] py-[20px]">
            ...
            <CardContent>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                {category.advantages.map((advantage: string, idx: number) => <div key={idx} className="flex items-start space-x-3 sm:space-x-4 p-2 sm:p-3 lg:p-4 bg-gray-50 rounded-lg">
